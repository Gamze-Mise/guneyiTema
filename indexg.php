    ...
    <header style="z-index: 50!important;" id="header">
        <div class="d-flex flex-column">
            ...
            <div class="profile">
                ...
                <h1 class="text-light"><a href="index.html">Güneyi Vural</a></h1>
            </div>
            ...
            <nav id="navbar" class="nav-menu navbar">
                <ul>
                    ...
                    <li><a id="idDvPublication" href="#services" class="nav-link scrollto"><i class="bx bx-server"></i> <span>Publications</span></a></li>
    ...
    <main id="main" style="background-color: #f0f0f0; ">
        ...
        <section id="resume" class="resume">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6" data-aos="fade-up">
                        <h3 class="resume-title" style="color: #1f5297">Subfield</h3>
                        <div class="resume-item">
                            <p>Geoscience Education</p>
                        </div>
                        <div class="resume-item">
                            <p>Geocognition</p>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <p style="text-align:justify">
                        ...
                        <b>(Bodrum Touristic Information System Web and Mobile Applications)</b>
                        Turkey Map Scıentıfıc And Technıcal Congress, Geoinformation Technologies and Software Fair, 3-6 May 2017,
                        Hacettepe Unıversity, Ankara
                    </p>
                    <hr>
                    <p style="text-align:justify">
                        <b>Vural, G.</b>, Dogru A.O., Demirel H., Seker D.Z. (2018):
                        <b>Visual analysis of human migration activities to Europe using GIS</b>,
                    ...
                    <div class="col-12 row d-flex align-items-stretch">
                        <div class="col-md-6 col-s-12 col-xs-12 mb-3 d-flex flex-column">
                            <p class="flex-grow-1" style="text-align:justify;">
                                You can read my essay titled
                                <a target="_blank" style="color:rgb(33, 37, 41); font-style:italic;" href="https://www.flipsnack.com/robertcollege/rc-journal-of-environmental-education-1-spring-2022/full-view.html">Environmental Awareness Through Geography Education</a>
                                on page 8 of this journal by clicking below.
                            </p>
                            <a target="_blank" href="https://www.flipsnack.com/robertcollege/rc-journal-of-environmental-education-1-spring-2022/full-view.html">
                                <img style="width: 50%; object-fit: contain;" src="assets/img/journal/journal.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-md-6 col-s-12 col-xs-12 mb-3 d-flex flex-column">
                            <p class="flex-grow-1" style="text-align:justify;">
                                You can read my essay titled
                                <a target="_blank" style="color:rgb(33, 37, 41); font-style:italic;" href="https://www.flipsnack.com/robertcollege/rc-journal-of-environmental-education-3-spring-2024/full-view.html">New Course Teaches Students to Map Solution to Climate Change</a>
                                on page 14 of this journal by clicking the link below.
                            </p>
                            <a target="_blank" href="https://www.flipsnack.com/robertcollege/rc-journal-of-environmental-education-3-spring-2024/full-view.html">
                                <img style="width: 50%; object-fit: contain;" src="assets/img/journal/journal-2.png" alt="">
                            </a>
                        </div>
                    </div>
                    ...
                    <hr>
                    <div class="mb-3">
                        <h5 class="text-center" style="font-size: medium"><b>Little Ice Age (1300-1850): A Focus On Physical Features And Effects On Humans </b></h5>
                        <div id="DvThesis2">
    ...
    <footer id="footer">
        <div class="container">
            <div style="display: none" class="copyright">
                ...
                <br>
                <strong><span>All Right Reserved</span></strong>
